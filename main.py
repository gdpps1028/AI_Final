...
from Radical_Stroke import rs_main

parser = argparse.ArgumentParser(description="A sample script using argparse")

parser.add_argument('-m', '--Model', type=str, help='C for Character, R for Radical, S for Stroke', default='C', choices=['C', 'R', 'S', 'RS'])
...
if __name__ == "__main__":
    if args.Model == 'C':
        ...
        rs_main.main(args.Train, args.Eval) 