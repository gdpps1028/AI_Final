...
# 設定來源路徑
src_images = Path("D:/chenm/nycu/AI/AI_Final/data_new")
...
for img_dir in src_images.iterdir():
    for img in img_dir.iterdir():
        char = img.stem.split('_')[0]
        char_to_images[char].append(src_images / img_dir / img)
